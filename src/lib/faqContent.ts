    ...
    items: [
      {
        ...
        answer:
          'RNKX supports Apple Watch, Garmin, WHOOP, Polar, COROS, and Fitbit.\n\nApple Watch, Garmin, Polar, COROS, and Fitbit support both Engine League and Run League scoring.\n\nWHOOP currently supports Engine League scoring only. Runs tracked with WHOOP still score in Engine League based on heart rate, ensuring no workout is wasted.\n\nPolar, COROS, and Fitbit connect through the device list in Settings.',
      },
      {
        question: 'Do I need to sync manually?',
        answer:
          'Apple Watch users need to tap Sync Workouts in Settings → Devices & Sync.\n\nGarmin, WHOOP, Polar, COROS, and Fitbit workouts sync automatically.',
      },
      {
