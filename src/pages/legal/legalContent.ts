...
export const PRIVACY_POLICY_SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    list: [
      ...
      'Device and wearable data: connected device types (e.g. Apple Watch, WHOOP, Garmin, Polar, COROS, Fitbit integrations via our partners), sync timestamps, and data you authorise us to receive from third-party health or fitness APIs.',
